sap.ui.define([
    ...
    return Controller.extend("fico.zprofitandloss.controller.Main", {
        formatter: formatter,
        ...
        _initialize: function () {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "zprofitandloss-View")) {
                ...
                this.getOwnerComponent().getModel("local").setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "zprofitandloss-View"),
                        Print: aAllAccessBtns.some(btn => btn.AccessId === "zprofitandloss-Print"),
                    },
                    data: {
            ...
            if (sEvent === "Print") {
                ...
                aContexts.forEach(oContext => {
                    items.push({
                        ...
                        PrevPeriodAmt: oContext.getObject().PrevPeriodAmt,
