...
], function (Base, BusyDialog, MessageBox, Filter, FilterOperator, Spreadsheet) {
    "use strict";

    return Base.extend("mm.zsuppliermasterreport.controller.Main", {
        ...
        _initialize: function () {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "zsuppliermasterreport-View")) {
                ...
                this.getModel("local").setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "zsuppliermasterreport-View")
                    },
                    data: {
        ...
        _exportExcel: function (mExcelSettings, sFileName) {
            mExcelSettings.workbook.columns.forEach(function (oColumn) {
                switch (oColumn.property) {
                    //  Date
                    case "CreationDate":
                    case "SuplrQltyInProcmtCertfnValidTo":
