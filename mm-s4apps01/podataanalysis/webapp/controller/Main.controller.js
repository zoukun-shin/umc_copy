            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                this.getModel("local").setProperty("/authorityCheck", {
                    button: {
                        ...
                        SyncHistory: aAllAccessBtns.some(btn => btn.AccessId === "podataanalysis-SyncHistory") // ADD BY XINLEI XU 2026/06/10 CM#6502
                    },
                    data: {
        ...
        onOpenHistoryDialog: function () {
            if (!this._pDialog) {
                this._pDialog = Fragment.load({
                    ...
                    name: "mm.podataanalysis.fragments.SyncHistoryDialog",
                    controller: this
