sap.ui.define([
    ...
    return Base.extend("mm.sourcelist.controller.Main", {
        onInit: function () {
        ...
        _initialize: function () {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "sourcelist-View")) {
                ...
                this.getOwnerComponent().getModel("local").setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "sourcelist-View")
                    },
                    data: {
