sap.ui.define([
    ...
    return Base.extend("mm.zsupplierdeliveryratioreport.controller.Main", {
        ...
        _initialize: function () {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "zsupplierdeliveryratioreport-View")) {
                ...
                this.getModel("local").setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "zsupplierdeliveryratioreport-View")
                    },
                    data: {
            ...
            mExcelSettings.workbook.columns.forEach(function (oColumn) {
                switch (oColumn.property) {
                    ...
                    case "DateLow":
                        ...
                        break;
                    //  整数类型 (Integer)
                    case "ReqDeliveryCount":
                    case "ActDeliveryCount":
                    ...
                    case "CountRatio":
                    case "QtyRatio":
                    case "OverallAchievementRate":
                        oColumn.type = sap.ui.export.EdmType.Percentage;
                        oColumn.scale = 2;
                        oColumn.hAlign = "End";
                        break;
                    //  数量类型 (Quantity) - 带单位参考
