    ...
    return {
        ...
        _getAuthorityData: function (oAuthorityModel, oLocalModel, oI18nModel, oViews) {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "zumespostingdatemgt-View")) {
                ...
                oLocalModel.setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "zumespostingdatemgt-View"),
                        Create: aAllAccessBtns.some(btn => btn.AccessId === "zumespostingdatemgt-Create"),
                        Edit: aAllAccessBtns.some(btn => btn.AccessId === "zumespostingdatemgt-Edit"),
                        Delete: aAllAccessBtns.some(btn => btn.AccessId === "zumespostingdatemgt-Delete")
                    },
                    data: {
