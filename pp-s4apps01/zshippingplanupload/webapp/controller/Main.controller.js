...
sap.ui.define([
    ...
    return Base.extend("pp.zshippingplanupload.controller.Main", {
        ...
        _initialize: function () {
            ...
            aNewFilters.push(new sap.ui.model.Filter("Object", sap.ui.model.FilterOperator.StartsWith, "ZUPLOAD_SP_"));
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "zshippingplanupload-View")) {
                ...
                this.getModel("local").setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "zshippingplanupload-View"),
                        Clear: aAllAccessBtns.some(btn => btn.AccessId === "zshippingplanupload-Clear"),
                        Check: aAllAccessBtns.some(btn => btn.AccessId === "zshippingplanupload-Check"),
                        Excute: aAllAccessBtns.some(btn => btn.AccessId === "zshippingplanupload-Excute"),
                        Export: aAllAccessBtns.some(btn => btn.AccessId === "zshippingplanupload-Export")
                    },
                    data: {
        ...
        _callODataAction: function (bEvent, aRequestData) {
            return new Promise((resolve, reject) => {
                var uploadProcess = this.getModel().bindContext("/ZC_SHIPPINGPLAN/com.sap.gateway.srvd.zui_shippingplan_o4.v0001.processLogic(...)");
