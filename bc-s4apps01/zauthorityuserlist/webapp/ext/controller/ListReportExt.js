sap.ui.define([
    ...
    return {
        ...
        getAuthorityData: function (oModels, oViews) {
            _myFunction = sap.ui.require("bc/zauthorityuserlist/ext/controller/ListReportExt");
        ...
        // ADD BEGIN BY XINLEI XU 2026/04/10 AMO#5876
        onDownload: function (oEvent) {
            ...
            aContexts.forEach(element => {
                ...
                aItems.push({
                    ...
                    Mail: decodeURIComponent(aSplitArray[1])
                });
            });
            if (aItems.length === 0) {
                aItems.push({
        ...
        _callODataAction: function (bEvent, aRequestData, that) {
            return new Promise((resolve, reject) => {
                var processLogic = that.getModel().bindContext("/User/com.sap.gateway.srvd.zui_permission_access_o4.v0001.processLogic(...)");
        ...
        // ADD END BY XINLEI XU 2026/04/10 AMO#5876
    };
});
