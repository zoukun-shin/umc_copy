sap.ui.define([
    ...
    var CONFIRM_CHANNEL_ID = "packDetail";
    var CONFIRM_EVENT_ID = "confirmAbandonChanges";

    return Controller.extend("sd.logisticscost.controller.PackDetail", {
        ...
        onEditPress: function() {
            var bEditMode = this._LocalData.getProperty("/packDetailEditMode");

            if (bEditMode) {
                this._switchToDisplayMode();
            } else {
                this._LocalData.setProperty("/packDetailEditMode", true);
            }
        },
            ...
            Object.keys(mPendingChanges).forEach(function(sPath) {
                ...
                if (oEntity) {
                    aChangedData.push({
                        ...
                        BillingDocumentItem: oEntity.BillingDocumentItem,
                        ActualFreightUnitPrice: oEntity.ActualFreightUnitPrice,
                        ActualFreightCost: oEntity.ActualFreightCost
                    });
                }
            });
        ...
        _switchToDisplayMode: function() {
            ...
            if (oModel.hasPendingChanges()) {
                ...
                this._LocalData.setProperty("/packDetailEditMode", false);
            }
        },
