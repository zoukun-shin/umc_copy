sap.ui.define([
    ...
    return Base.extend("sd.deliverynoteprint.controller.Main", {
        formatter: formatter,
        ...
        _initialize: function () {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "deliverynoteprint-View")) {
                ...
                this.getModel("local").setProperty("/authorityCheck", {
                    button: {
                        Report: aAllAccessBtns.some(btn => btn.AccessId === "deliverynoteprint-listView"),
                        PrintNM: aAllAccessBtns.some(btn => btn.AccessId === "deliverynoteprint-listPrintNM"),
                        PrintFJ: aAllAccessBtns.some(btn => btn.AccessId === "deliverynoteprint-listPrintFJ"),
                        PrintQT: aAllAccessBtns.some(btn => btn.AccessId === "deliverynoteprint-listPrintQT"),
        ...
        onBeforeRebindTable: function (oEvent) {
            ...
            var sPartsShipping = this.byId("idCB1").getSelected();

            if (sPartsShipping === true) {
                var oIndicator1Filter = new sap.ui.model.Filter({
                    path: "PartsShipping",
                    operator: "EQ",
                    value1: sPartsShipping
                });
        ...
        porcessPrintContent: function (aItems) {
            ...
            var Print = {
                Companyname1:aItems[0].COMPANY1,
                Companyname2:aItems[0].COMPANY2,
                Title:aItems[0].TITLE,
                Title2:aItems[0].TITLE2,
                Customer:aItems[0].CUSTOMER,
                Container:aItems[0].CONTAINER,
                Trucknumber:aItems[0].TRUCKNUMBER,
