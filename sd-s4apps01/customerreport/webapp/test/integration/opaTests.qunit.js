...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "sd/customerreport/test/integration/FirstJourney",
    "sd/customerreport/test/integration/CustomerReportListJourney",
    "sd/customerreport/test/integration/CustomerReportObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
