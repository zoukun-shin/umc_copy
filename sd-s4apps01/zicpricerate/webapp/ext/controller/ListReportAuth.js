    ...
    return {
        ...
        _getAuthorityData: function (oAuthorityModel, oLocalModel, oI18nModel, oViews) {
            ...
            oContextBinding.requestObject().then(function (context) {
                ...
                if (!aAllAccessBtns.some(btn => btn.AccessId === "zicpricerate-View")) {
                ...
                oLocalModel.setProperty("/authorityCheck", {
                    button: {
                        View: aAllAccessBtns.some(btn => btn.AccessId === "zicpricerate-View"),
                        Upload: aAllAccessBtns.some(btn => btn.AccessId === "zicpricerate-Upload"),
                        Clear: aAllAccessBtns.some(btn => btn.AccessId === "zicpricerate-Clear"),
                        Check: aAllAccessBtns.some(btn => btn.AccessId === "zicpricerate-Check"),
                        Excute: aAllAccessBtns.some(btn => btn.AccessId === "zicpricerate-Excute"),
                        Export: aAllAccessBtns.some(btn => btn.AccessId === "zicpricerate-Export"),
                        Edit: aAllAccessBtns.some(btn => btn.AccessId === "zicpricerate-Edit"),
                        Delete: aAllAccessBtns.some(btn => btn.AccessId === "zicpricerate-Delete")
                    },
                    data: {
