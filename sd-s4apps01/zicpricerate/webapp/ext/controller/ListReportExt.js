sap.ui.define([
    ...
    return {
        ...
        openUploadDialog: function () {
            var that = this;
            this._Function = sap.ui.require("sd/zicpricerate/ext/controller/ListReportExt");
            this._BusyDialog = new BusyDialog();
            this._BusyDialog.open();
            Fragment.load({
                name: "sd.zicpricerate.ext.fragments.Upload",
                controller: this
            ...
            oReader.onload = function (e) {
                ...
                for (var i = 1; i < aSheetData.length; i++) {
                    var item = {
                        ...
                        "SoldToParty": aSheetData[i]["SoldToParty"] === undefined ? "" : aSheetData[i]["SoldToParty"],
                        "ShipToParty": aSheetData[i]["ShipToParty"] === undefined ? "" : aSheetData[i]["ShipToParty"],
                        "SalesDocumentType": aSheetData[i]["SalesDocumentType"] === undefined ? "" : aSheetData[i]["SalesDocumentType"],
                        "Yy1SalesdoctypeSdh": aSheetData[i]["Yy1SalesdoctypeSdh"] === undefined ? "" : aSheetData[i]["Yy1SalesdoctypeSdh"],
                        "Rate": aSheetData[i]["Rate"] === undefined ? "" : aSheetData[i]["Rate"]
        ...
        _callODataAction: function (bEvent, aRequestData, that) {
            return new Promise((resolve, reject) => {
                var uploadProcess = that.getModel("ICPrice").bindContext("/ICPRICERATE/com.sap.gateway.srvd.zui_icpricerate_o4.v0001.processLogic(...)");
