sap.ui.define([
	...
	return Controller.extend("sd.printpackinglist.controller.BaseController", {
		...
		getUser: function () {
			...
			return oUserInfo.getFullName() === undefined ? "" : oUserInfo.getFullName();
		},
		getEmail: function () {
			let oUserInfo = sap.ushell.Container.getService("UserInfo");
			return oUserInfo.getEmail() === undefined ? "" : oUserInfo.getEmail();
		},
