sap.ui.define([
    ...
    return Base.extend("sd.materialpricedetail.controller.List1", {
        formatter: formatter,
        onInit() {
            var that = this;
        ...
        onBeforeRebindTable: function (oEvent) {
            ...
            //Tab1
            afilters.push(new sap.ui.model.Filter("Type", "EQ", "1"));
        },

        onBeforeExport: function (oEvent) {
            var mExcelSettings = oEvent.getParameter("exportSettings");
            var sFileName = this.getModel("i18n").getResourceBundle().getText("title1");
